...
I'm a **Fullstack Web and Mobile Developer** with over **10 years** of experience specializing in the **MERN Stack** (MongoDB, Express.js, React/React Native, Node.js) to build dynamic, responsive web applications. I focus on creating **e-commerce** solutions with expertise in **BigCommerce**, **Shopify**, **WooCommerce**, and mobile app development using **React Native** and **Flutter**. I also have experience in both frontend and backend development.
...
- 📄 [Resume](https://drive.google.com/file/d/1ZiWDpDS-zfCO0Xig19jL-6Z-Q7QyPqUX/view?usp=sharing)
